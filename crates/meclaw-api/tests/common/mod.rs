...
//! GH #644 added a fourth: the process's mount table. A test that has no
//! surface cell passes a fresh empty registry.
...
/// let app = build_router(api_colony, blob_store, meclaw_core::MESSAGE_DEFAULT_TTL, surfaces);
/// ```
