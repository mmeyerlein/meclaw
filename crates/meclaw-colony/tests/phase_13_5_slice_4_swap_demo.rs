...
async fn normal_disconnect_still_dlqs_remainder_no_a1_regression() {
    ...
    // the β params-message test binaries (CONTRIBUTING.md: generous failure markers).
    ...
    // against full-workspace cargo-parallel saturation (CONTRIBUTING.md: failure-marker
