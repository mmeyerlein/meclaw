...
| `1013` | The cell did not take the session within `external_timeout_ms` of the upgrade (since `voice@2.2.2`, GH #836). No `hello` was sent, nothing is registered under the session, and a reconnect is the answer: the cell was busy, not broken. |
